    ...
    <>
      ...
      {loading ? (
        ...
        <div className="w-full mx-auto rounded-md h-120 overflow-hidden">
          ...
          >
            <h2 className="text-foreground text-2xl md:text-4xl font-bold text-center">
              {error}
            </h2>
            <p className="text-muted-foreground text-sm md:text-base max-w-xl mt-4 text-center">
              Something went wrong while trying to load the products. Please try again.
            </p>
            <Button onClick={() => fetchProducts(1)} variant="outline" className="mt-6">Retry</Button>
          </Vortex>
        </div>
      ) : products.length === 0 ? (
